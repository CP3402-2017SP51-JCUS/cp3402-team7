...
Responsive product catalog plugin designed to display your products in a sleek and easy to customize product catalog format.
...
* See "Additional Features" below by clicking "Read More"

[youtube https://www.youtube.com/watch?v=2oWxZtlKZQ0]

<strong>With full WooCommerce Integration!</strong> See the "WooCommerce Integration" section below for full details and features.
...
** We are pleased to offer a free 7-day trial of the premium version, which users can use to test out all the features before buying the premium version! **
...
8. View of the "Tabbed Layout" catalog product page with breadcrumbs enabled
9. View of different control types, available for categories, sub-categories, tags and custom fields
10. View of category image in sidebar, also showing compare mode and catalog price slider
11. View of the product comparison page
12. Hierarchical sub-category display
13. View of the catalog "Product Inquiry Form" inclusion from the Contact Form 7 plugin
14. View of the "Custom Page Layout" catalog product page
15. View of catalog page with Lightbox Mode enabled
16. Sale mode enabled for a product on the catalog page
17. Sale price on product page
18. Ultimate Reviews integration on product page
19. View of the Catalog Overview Mode
20. View of the "Dashboard" tab
21. View of the "Products" tab
22. View of the "Catalogues" tab
23. View of the catalog edit screen showing the alphabetical sorting options
24. View of the "Categories" tab
25. View of the "Custom Fields" tab
26. View of the "Product Page" tab showing custom product page layout builder
27. View of the "Basic" area of the "Options" tab
28. View of the "Premium" area of the "Options" tab
29. View of the "WooCommerce" area of the "Options" tab
30. View of the "SEO" area of the "Options" tab
31. View of the "Labelling" area of the "Options" tab
32. View of the "Catalogue" area of the "Styling" tab
